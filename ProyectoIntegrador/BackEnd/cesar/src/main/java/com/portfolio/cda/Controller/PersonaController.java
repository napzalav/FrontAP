...
public class PersonaController {
    ...
    /* Está comentado el delete y el create xq no borraremos ni crearemos personas, nos basaremos en un solo perfil
